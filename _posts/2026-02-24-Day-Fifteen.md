...
tags: [plan-B, foi]
---
Ran the data refresh pipeline for the first time in anger today and nothing fell over. I am taking that as a win. Ran clustering on the PIT arguments and used that to pick out the most common ones. This works much better than being able to see all of them individually. I am not yet sure where I am going to present these in the appeal writing workflow, and it needs proper thought. For now, I've popped it underneath the tool and the template box.
